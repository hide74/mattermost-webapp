...
>>>>>>> 81cd06e7d8bcb3a1366e824477f304ef9b399465
    ...
    onClickCloseChannel = () => {
        console.count('ChannelView#onClickCloseChannel'); // TODO: Implement
    }

    componentDidUpdate(prevProps) {
        if (prevProps.channelId !== this.props.channelId || prevProps.isDeleted !== this.props.isDeleted) {
    ...
    render() {
        const channelIsArchived = this.props.isDeleted;
                ...
                >
                    ...
                    {channelIsArchived &&
                        <div className='channel-archived__message'>
                            ...
                            >
                                <FormattedMessage
                                    id='center_paen.archived.closeChannel'
